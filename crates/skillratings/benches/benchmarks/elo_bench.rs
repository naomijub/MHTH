...
pub fn rating_period_elo(c: &mut Criterion) {
    ...
    let results = vec![
        (EloRating { rating: 291.1 }, Outcomes::SUCCESSFUL),
        (EloRating { rating: 391.1 }, Outcomes::DRAW),
        (EloRating { rating: 491.1 }, Outcomes::FAILURE),
        (EloRating { rating: 591.1 }, Outcomes::SUCCESSFUL),
        (EloRating { rating: 691.1 }, Outcomes::DRAW),
        (EloRating { rating: 791.1 }, Outcomes::FAILURE),
        (EloRating { rating: 891.1 }, Outcomes::SUCCESSFUL),
        (EloRating { rating: 991.1 }, Outcomes::DRAW),
        (EloRating { rating: 1091.1 }, Outcomes::FAILURE),
        (EloRating { rating: 1191.1 }, Outcomes::FAILURE),
    ];
