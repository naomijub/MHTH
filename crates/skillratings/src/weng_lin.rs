...
mod tests {
    ...
    fn test_weng() {
        ...
        let (t1, t2) = weng_lin(&p1, &p2, &Outcomes::SUCCESSFUL, &WengLinConfig::new());
        ...
        let (t1, t2) = weng_lin(&p1, &p2, &Outcomes::FAILURE, &WengLinConfig::new());
    ...
    fn test_weng_two_teams() {
        ...
        let (nt1, nt2) = weng_lin_two_teams(&t1, &t2, &Outcomes::SUCCESSFUL, &WengLinConfig::new());
        ...
        let (nt1, nt2) =
            weng_lin_two_teams(&t1, &t2, &Outcomes::FAILURE, &WengLinConfig::default());
