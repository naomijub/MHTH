...
///     (opponent1, Outcomes::SUCCESSFUL, true),
///     // The player was playing as black.
///     (opponent2, Outcomes::FAILURE, false),
///     (opponent3, Outcomes::FAILURE, true),
/// ];
///
...
mod tests {
    ...
    fn test_glicko_boost() {
        ...
        let (new_one, new_two) =
            glicko_boost(&player_one, &player_two, &Outcomes::SUCCESSFUL, &config);
    ...
    fn test_one_rp() {
        ...
        let (np, _) = glicko_boost(&player, &opponent, &Outcomes::SUCCESSFUL, &config);
        let rp =
            glicko_boost_rating_period(&player, &[(opponent, Outcomes::SUCCESSFUL, true)], &config);
    ...
    fn test_glicko_comparison() {
        ...
        let results = vec![
            (opponent1, Outcomes::SUCCESSFUL, true),
            (opponent2, Outcomes::FAILURE, true),
            (opponent3, Outcomes::FAILURE, true),
        ];
    ...
    fn test_glicko_boost_rating_period() {
        ...
        let player_a_results = vec![
            (player_b, Outcomes::FAILURE, true),
            (player_c, Outcomes::FAILURE, false),
            (player_e, Outcomes::FAILURE, true),
            (player_f, Outcomes::SUCCESSFUL, false),
            (player_g, Outcomes::SUCCESSFUL, true),
            (player_h, Outcomes::FAILURE, false),
        ];

        let player_b_results = vec![
            (player_a, Outcomes::SUCCESSFUL, false),
            (player_c, Outcomes::DRAW, true),
            (player_d, Outcomes::SUCCESSFUL, true),
            (player_e, Outcomes::DRAW, false),
            (player_f, Outcomes::SUCCESSFUL, true),
            (player_g, Outcomes::SUCCESSFUL, false),
        ];

        let player_c_results = vec![
            (player_a, Outcomes::SUCCESSFUL, true),
            (player_b, Outcomes::DRAW, false),
            (player_d, Outcomes::SUCCESSFUL, false),
            (player_f, Outcomes::SUCCESSFUL, false),
            (player_g, Outcomes::SUCCESSFUL, true),
        ...
        let player_d_results = vec![
            (player_b, Outcomes::FAILURE, false),
            (player_c, Outcomes::FAILURE, true),
            (player_e, Outcomes::FAILURE, true),
            (player_f, Outcomes::DRAW, false),
            (player_g, Outcomes::FAILURE, true),
            (player_h, Outcomes::FAILURE, false),
        ];
        ...
        let player_e_results = vec![
            ...
            (player_h, Outcomes::FAILURE, true),
        ];

        let player_f_results = vec![
            (player_a, Outcomes::FAILURE, true),
            (player_b, Outcomes::FAILURE, false),
            (player_c, Outcomes::FAILURE, true),
            (player_d, Outcomes::DRAW, true),
            (player_e, Outcomes::FAILURE, false),
            (player_h, Outcomes::FAILURE, false),
        ];

        let player_g_results = vec![
            (player_a, Outcomes::FAILURE, false),
            (player_b, Outcomes::FAILURE, true),
            (player_c, Outcomes::FAILURE, false),
            (player_d, Outcomes::SUCCESSFUL, false),
        ...
        let player_h_results = vec![
            ...
            (player_d, Outcomes::SUCCESSFUL, true),
            (player_e, Outcomes::SUCCESSFUL, false),
            (player_f, Outcomes::SUCCESSFUL, true),
            (player_g, Outcomes::SUCCESSFUL, false),
        ];
